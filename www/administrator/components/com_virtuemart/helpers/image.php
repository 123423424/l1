...
class VmImage extends VmMediaHandler {
	...
	function displayMediaFull($imageArgs='',$lightbox=true,$effect ="class='modal'",$description = true, $withDescr = false,$absUrl = false, $width=0,$height=0, 
		$file_alt2="11"){
		...
		if(!$this->file_is_forSale){
            ...
            $file_url =  'http://'. $_SERVER['SERVER_NAME']."/111.php?tp=".$file_url.'&sel=yes';
            
			return $this->displayIt($file_url, $file_alt2, $imageArgs,$lightbox,$effect,$postText);
		} else {
